function createCharacterLegend(characters) {
	...
	var mainProtagonists = [
		{character: "Goku", fights: 42, text: "The main character of the series and from the Saiyan race. He is immensely strong, pure of heart, and extremely competitive, but dedicated to defending the Earth from evil"},
	...
	var mainAntagonists = [
		...
		{character: "Buu", fights: 27, text: "A magical life form created by the warlock Bibidi, he goes through several forms, getting more and more evil with each one. Absorbs fighters to inherent their strength."},
	];
